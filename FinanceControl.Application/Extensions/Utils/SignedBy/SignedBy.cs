...
namespace FinanceControl.Application.Extensions.Utils.SignedBy
{
    ...
    {
        public void SignedByWallet(string userName, FamilyMemberModel familyMember, TransactionsModel model, string nameWallet, IEmail email, string subjectEmail)
        {
            ...
            else
            {
                ...
                try
                {
                    var template = email.TemplateTransactionNotification(userName, model.Name, model.Repetition.ValueInstallment, nameWallet, "Carteira");
