...
namespace FinanceControl.Infra.BaseEnvironment;
...
public static class BaseEnvironment
{
    ...
    public static bool IsHomologationEnviroment(this IHostEnvironment hostEnvironment)
    {
        if (hostEnvironment == null)
        {
            return true;
        ...
        {
            return hostEnvironment.EnvironmentName.Equals("hmg") || hostEnvironment.EnvironmentName.ToLower().Equals("homologation");
        }
    }
