...
public class AppSettings : IAppSettings
{
    ...
    private readonly IRequestContainer _requestContainer;
    #endregion
    ...
    public AppSettings(IMapper mapper = null,
        ...
        IRequestContainer requestContainer = null)
    {
        _mapper = mapper;
        _mongoDb = mongoDb;
    ...
    public IRequestContainer GetRequestContainer() => _requestContainer;
    #endregion
}