...
namespace FinanceControl.Infra.BaseService;

public class BaseService<S> : IDisposable
{
    #region [ Fields ]
    public void Dispose()
    {
    ...
    public readonly IRequestContainer _requestContainer;
    ...
    {
        _logger = appSettings.GetLogger().ForContext<S>();
        _appSettings = appSettings;
        _mapper = appSettings.GetMapper();
        _requestContainer = appSettings.GetRequestContainer();
    }
    #endregion
    ...
    public Guid GetCurrentUserId() => _requestContainer.UserId;
    #endregion
